...
var _payOrder = __webpack_require__(249);
...
__vue_options__.__file = "F:\\weex项目\\教练购课\\buyCourse\\src\\components\\HelloWorld.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
...
exports.default = {
  components: { WxcLoading: _weexUi.WxcLoading },
  data: function data() {
    return {
      isDelete: false,
      defaultTitle: '', //课程生效日期
      ...
      month: '',
      day: '',
      saleList: [{ name: '新购课', id: 1, checked: false }, { name: '续课', id: 2, checked: false }, { name: 'pos销售', id: 3, checked: false }, { name: '场地开发', id: 4, checked: false }, { name: '交叉课', id: 5, checked: false }, { name: '会员转介绍', id: 8, checked: false }, { name: '体验课出单', id: 9, checked: false }, { name: '其他', id: 16, checked: false }], //销售类型列表
      ...
      precentList: [{ name: '分成10%', id: 1, checked: false }, { name: '分成20%', id: 2, checked: false }, { name: '分成30%', id: 3, checked: false }, { name: '分成40%', id: 4, checked: false }, { name: '分成50%', id: 5, checked: false }, { name: '分成60%', id: 6, checked: false }, { name: '分成70%', id: 7, checked: false }, { name: '分成80%', id: 8, checked: false }, { name: '分成90%', id: 9, checked: false }], //分成列表
  ...
  created: function created() {
    ...
    setTimeout(function () {
      that.getCourseList();
      that.getOrder();
      storage.getItem('isSkipSign', function (event) {
  ...
  methods: {
    ...
    deleteAndEditOrder: function deleteAndEditOrder() {
      var that = this;
      stream.fetch({
        method: "DELETE",
        type: 'json',
    ...
    //跳转审批详情
    toApprovalDetail: function toApprovalDetail() {
      TrainerNativeModule.goToApprovalDetail(this.approvalId);
    },

    //跳转合同页面
    toSignPage: function toSignPage() {
      ...
      stream.fetch({
        ...
        if (!ret.ok) {
          ...
          if (ret.data.status == 0) {
            ...
            if (course.assistSellerId == undefined || course.assistSellerId == '' || course.assistSellerId == null) {} else {
    ...
    //获取课时
    getCourseNum: function getCourseNum(event) {
    ...
    //隐藏选课等列表
    hideCourseList: function hideCourseList() {
      var that = this;
      if (that.data == '选择课程') {
        if (that.courseItem == '') {
          TrainerNativeModule.close();
    ...
    //确定选择课程等
    getCourseItem: function getCourseItem() {
      var that = this;
      if (that.data == '选择课程') {
        for (var i = 0; i < that.list.length; i++) {
          if (that.list[i].checked) {
    ...
    //选择课程
    chooseCourseItem: function chooseCourseItem(id) {
      var that = this;
      for (var i = 0; i < that.list.length; i++) {
    ...
    //选择定金
    choosePannyItem: function choosePannyItem(id) {
      var that = this;
    ...
    //显示选课
    chooseCouseType: function chooseCouseType() {
    ...
    //显示销售分成
    choosePrecent: function choosePrecent() {
      this.$refs.inputText.blur();
      if (this.types == 1) {
        this.$refs.numText.blur();
      }
    ...
    //显示定金列表
    selectPenny: function selectPenny() {
      this.$refs.inputText.blur();
      if (this.types == 1) {
        this.$refs.numText.blur();
      }
    ...
    //隐藏定金
    hidePannyList: function hidePannyList() {
      var that = this;
      that.componentVisibility = 'visible';
    ...
    //获取定金
    getpannyItem: function getpannyItem() {
      var that = this;
      var allMoney = [];
      for (var i = 0; i < that.pannyList.length; i++) {
        if (that.pannyList[i].checked) {
    ...
    //显示协助销售
    chooseHelpSale: function chooseHelpSale() {
      this.$refs.inputText.blur();
      if (this.types == 1) {
        this.$refs.numText.blur();
      }
    ...
    //指定日期
    appointTime: function appointTime() {
      var that = this;
    ...
    //详情页返回
    returnCourse: function returnCourse() {
      //关闭当前页面
      TrainerNativeModule.close();
      storage.removeItem('isSkipSign');
    },
    ...
    //获取应付金额
    getMoney: function getMoney(event) {
      //  TrainerNativeModule.toast(this.num);
    },

    //应收金额失焦时计算金额
    conmuterMoney: function conmuterMoney() {
      //     var that=this;
      //     that.$refs.moneyText.blur();
      //     if(that.pannyItem=='选择可用定金'){
      //         that.payMoney=that.money;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: ["wrapper"]
  }, [((_vm.showCoursePage)) ? _c('div', {
    staticClass: ["coursePage"],
    style: {
      height: _vm.height
    }
  }, [_c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("办理" + _vm._s(_vm.restrictTraining ? '培训课' : '私教课'))]), _c('text', {
    staticClass: ["nullBox"]
  }, [_vm._v("保存")])]), _c('div', {
    staticClass: ["courseContent"]
  }, [((_vm.showChooseCourse)) ? _c('div', {
    staticClass: ["cousrHeader"]
  }, [_c('div', {
    staticClass: ["coursePrice"]
  }, [_c('image', {
    staticClass: ["courseImg"],
    attrs: {
      "src": _vm.courseImg
    }
  })]), _c('div', {
    staticClass: ["reChooseCourse"],
    on: {
      "click": _vm.chooseCouseType
    }
  }, [_c('text', {
    staticClass: ["txt"]
  }, [_vm._v("请选择" + _vm._s(_vm.restrictTraining ? '培训课' : '私教课'))]), _c('image', {
    staticClass: ["chooseImg"],
    attrs: {
      "src": "http://bocai-center.oss-cn-hangzhou.aliyuncs.com/center_manager/static_img/Rectanglex.png"
    }
  })])]) : _c('div', {
    staticClass: ["cousrHeaders"]
  }, [_c('div', {
    staticClass: ["coursePrice"]
  }, [_c('image', {
    staticClass: ["courseImg"],
    ...
    staticClass: ["reChooseCourses"],
    on: {
      "click": _vm.chooseCouseType
    }
  }, [_c('div', {
    staticClass: ["courseMess"]
  }, [_c('text', {
    staticClass: ["courseName"]
  }, [_vm._v(_vm._s(_vm.courseItem))]), _c('div', {
    staticClass: ["priceBox"]
  }, [_c('text', {
    staticClass: ["priceIcon"]
  }, [_vm._v("￥")]), _c('text', {
    staticClass: ["realPrice"]
  }, [_vm._v(_vm._s(_vm.realPrice))]), (_vm.types == 2) ? _c('text', {
    staticClass: ["realDay"]
  }, [_vm._v("/" + _vm._s(_vm.effectiveDays) + "天")]) : _c('text', {
    staticClass: ["realDay"]
  }, [_vm._v("/节")])])]), _c('image', {
    staticClass: ["chooseImg"],
    attrs: {
    ...
    staticClass: ["conditionList"]
  }, [_c('div', {
    staticClass: ["childrens"]
  }, [_vm._m(1), _c('div', {
    staticClass: ["chooseCondition"],
    on: {
      "click": _vm.saleStyle
    }
  }, [_c('text', {
    staticClass: ["txt"]
  }, [_vm._v(_vm._s(_vm.saleTypeItem))]), _c('image', {
    staticClass: ["chooseImg"],
    attrs: {
      "src": "http://bocai-center.oss-cn-hangzhou.aliyuncs.com/center_manager/static_img/Rectanglex.png"
    }
    ...
    staticClass: ["chooseTime"]
  }, [_c('image', {
    staticClass: ["reduceImg"],
    attrs: {
      "src": "https://bocai-center.oss-cn-hangzhou.aliyuncs.com/center_manager/static_img/reduce.png"
    },
    on: {
      "click": _vm.reduceNum
    }
    ...
    on: {
      "input": _vm.getCourseNum,
      "blur": _vm.getMoney
    }
  }), _c('image', {
    staticClass: ["reduceImg"],
    attrs: {
      "src": "https://bocai-center.oss-cn-hangzhou.aliyuncs.com/center_manager/static_img/add.png"
    },
    on: {
      "click": _vm.addNum
    }
  })])]) : _vm._e(), ((_vm.types == 2)) ? _c('div', {
    staticClass: ["childrens"]
  }, [_vm._m(3), _c('div', {
    staticClass: ["chooseTime"]
  }, [_c('text', {
    class: [_vm.effectiveType === 2 ? 'active' : 'firstClass'],
    on: {
      "click": _vm.firstTime
    }
  }, [_vm._v("首次上课生效")]), _c('text', {
    class: [_vm.effectiveType === 1 ? 'active' : 'appointClass'],
    on: {
      "click": _vm.appointTime
    }
  }, [_vm._v("指定日期生效")])])]) : _vm._e(), ((_vm.effectiveType === 1)) ? _c('div', {
    ...
    staticClass: ["startName"]
  }, [_vm._v("生效日期")]), _c('text', {
    staticClass: ["dating"]
  }, [_vm._v(_vm._s(_vm.defaultTitle))])]), _c('div', {
    staticClass: ["startTime"]
  }, [_c('text', {
    staticClass: ["startName"]
  }, [_vm._v("有效日期")]), _c('text', {
    staticClass: ["dating"]
  }, [_vm._v(_vm._s(_vm.endDate))])])]) : _vm._e(), (_vm.types == 1 && (_vm.effectiveDaysUnitType == 5 || _vm.effectiveDaysUnitType == 6)) ? _c('div', {
    staticClass: ["childrens"]
  }, [_vm._m(4), _c('div', {
    staticClass: ["chooseCondition"]
  }, [_c('text', {
  ...
  }, [_vm._v(_vm._s(_vm.endDate))])])]) : _vm._e(), _c('div', {
    staticClass: ["childrens"]
  }, [_vm._m(5), _c('div', {
    staticClass: ["chooseCondition"]
  }, [_c('input', {
    ...
    on: {
      "input": _vm.getNum,
      "blur": _vm.conmuterMoney
    }
  })])]), ((_vm.pannyList.length > 0)) ? _c('div', {
    staticClass: ["childrens"]
  }, [_vm._m(6), _c('div', {
    staticClass: ["chooseCondition"],
    on: {
      "click": _vm.selectPenny
    }
  }, [_c('text', {
    staticClass: ["txt"]
  }, [_vm._v(_vm._s(_vm.pannyItem || '选择可用定金'))]), _c('image', {
    staticClass: ["chooseImg"],
    attrs: {
      "src": "http://bocai-center.oss-cn-hangzhou.aliyuncs.com/center_manager/static_img/Rectanglex.png"
    }
    ...
    staticClass: ["chooseCondition"],
    on: {
      "click": _vm.chooseHelpSale
    }
  }, [_c('text', {
    staticClass: ["txt"]
  }, [_vm._v(_vm._s(_vm.helpSaleItem))]), _c('image', {
    staticClass: ["chooseImg"],
    attrs: {
      "src": "http://bocai-center.oss-cn-hangzhou.aliyuncs.com/center_manager/static_img/Rectanglex.png"
    }
    ...
    staticClass: ["chooseCondition"],
    on: {
      "click": _vm.choosePrecent
    }
  }, [_c('text', {
    staticClass: ["txt"]
  }, [_vm._v(_vm._s(_vm.precentItem))]), _c('image', {
    staticClass: ["chooseImg"],
    attrs: {
      "src": "http://bocai-center.oss-cn-hangzhou.aliyuncs.com/center_manager/static_img/Rectanglex.png"
    }
    ...
    staticClass: ["marksName"]
  }, [_vm._v("备注")]), _c('textarea', {
    ref: "inputText",
    staticClass: ["markContent"],
    attrs: {
      "placeholder": "输入备注内容",
      "maxlength": "150",
      "value": (_vm.notes)
    ...
    on: {
      "input": [function($event) {
        _vm.notes = $event.target.attr.value
      }, _vm.oninput]
    }
  })])]), ((_vm.isShowchooseCourse)) ? _c('div', {
    staticClass: ["bg"],
    style: {
      height: _vm.height
    },
    ...
    staticClass: ["dispire"],
    on: {
      "click": _vm.hideCourseList
    }
  }, [_vm._v("取消")]), _c('text', {
    staticClass: ["titles"]
  }, [_vm._v(_vm._s(_vm.data))]), _c('text', {
    staticClass: ["finish"],
    on: {
      "click": _vm.getCourseItem
    }
  }, [_vm._v("确定")])]), _c('list', {
  ...
  }, [(_vm.listType == 1) ? _c('div', _vm._l((_vm.list), function(item, index) {
    return _c('div', {
      key: index,
      staticClass: ["lists"],
      on: {
        "click": function($event) {
          _vm.chooseCourseItem(item.id)
        }
      }
    }, [_c('text', {
  ...
  })) : _vm._e(), (_vm.listType == 2) ? _c('div', [_c('text', {
    class: [_vm.isEmpty ? 'emptyOptionSelect' : 'emptyOption'],
    on: {
      "click": _vm.emptySale
    }
  }, [_vm._v("无")]), _vm._l((_vm.list), function(item, index) {
    return _c('div', {
      key: index,
      staticClass: ["lists"],
      on: {
  ...
  })], 2) : _vm._e(), (_vm.listType == 3) ? _c('div', [_c('text', {
    class: [_vm.isEmpty ? 'emptyOptionSelect' : 'emptyOption'],
    on: {
      "click": _vm.emptySale
    }
  ...
  })], 2) : _vm._e(), (_vm.listType == 4) ? _c('div', [_c('text', {
    class: [_vm.isEmpty ? 'emptyOptionSelect' : 'emptyOption'],
    on: {
      "click": _vm.emptySale
    }
    ...
    staticClass: ["money"]
  }, [_vm._v(_vm._s(_vm.payMoney))])]), _c('text', {
    staticClass: ["placeOrder"],
    on: {
      "click": _vm.toOrder
    }
  }, [_vm._v("提交订单")])]), ((_vm.earnestMoney)) ? _c('div', {
    staticClass: ["bg"],
    style: {
      height: _vm.height
    },
  ...
  }, _vm._l((_vm.pannyList), function(item, index) {
    return _c('div', {
      key: index,
      staticClass: ["pannyLists"],
      on: {
        "click": function($event) {
          _vm.choosePannyItem(item.id)
        }
      }
    }, [_c('text', {
      class: [item.checked ? 'selects' : 'content']
    }, [_vm._v(_vm._s(item.sellerName))]), _c('text', {
      class: [item.checked ? 'selects' : 'content']
    ...
    staticClass: ["returnImgs"],
    on: {
      "click": _vm.returnCourse
    }
  }, [_c('image', {
    ...
    staticClass: ["peopleAvatar"],
    attrs: {
      "src": _vm.orderPeopleImg
    }
  })]), _c('div', {
    staticClass: ["nameAndPhone"]
  }, [_c('text', {
    staticClass: ["customerName"]
  }, [_vm._v(_vm._s(_vm.orderPeopleName))]), _c('div', {
    staticClass: ["phones"]
  }, [_c('image', {
    staticClass: ["phoneImg"],
    attrs: {
      "src": "https://bocai-center.oss-cn-hangzhou.aliyuncs.com/center_manager/static_img/phone.png"
    }
  }), _c('text', {
    staticClass: ["phoneTxt"]
  }, [_vm._v(_vm._s(_vm.orderPeoplePhone || '--'))])])])]), (_vm.payResult == 1) ? _c('text', {
    staticClass: ["payDone"],
    staticStyle: {
      color: "#303030"
    }
  }, [_vm._v("已完成")]) : _vm._e(), (_vm.payResult == -3) ? _c('text', {
    staticClass: ["payDone"],
    staticStyle: {
      color: "#6E6E6E"
    },
    on: {
      "click": _vm.toApprovalDetail
    }
  }, [_vm._v("撤销审批")]) : _vm._e(), (_vm.payResult == -2) ? _c('text', {
    staticClass: ["payDone"],
    staticStyle: {
      color: "#EF8D8D"
    },
  ...
  }, [_vm._v("审批驳回")]) : _vm._e(), (_vm.payResult == -1) ? _c('text', {
    staticClass: ["payDone"],
    staticStyle: {
      color: "#FF9D3B"
    },
  ...
  }, [_vm._v("审批中")]) : _vm._e(), (_vm.payResult == 0 && (_vm.approvalId == '' || _vm.approvalId == null || _vm.approvalId == undefined)) ? _c('text', {
    staticClass: ["payDone"],
    staticStyle: {
      color: "#FF9D3B"
    }
  }, [_vm._v("待付款")]) : _vm._e(), (_vm.payResult == 0 && _vm.approvalId != '' && _vm.approvalId != null && _vm.approvalId != undefined) ? _c('text', {
    staticClass: ["payDone"],
    staticStyle: {
      color: "#72BFA7"
    },
  ...
  }, [_vm._v("审批通过")]) : _vm._e()]), _c('div', {
    staticClass: ["orderMess"]
  }, [_vm._m(9), _c('div', {
  ...
  }, [_vm._v(_vm._s(_vm.orderCourseName))])]), (_vm.isHours) ? _c('div', {
    staticClass: ["listChildren"]
  }, [_c('text', {
    staticClass: ["projectName"]
  }, [_vm._v("有效节数")]), _c('text', {
    staticClass: ["projectContent"]
  }, [_vm._v(_vm._s(_vm.orderCourseCont) + "节")])]) : _c('div', {
    staticClass: ["listChildren"]
  }, [_c('text', {
    staticClass: ["projectName"]
  }, [_vm._v("有效天数")]), _c('text', {
    staticClass: ["projectContent"]
  }, [_vm._v(_vm._s(_vm.orderCourseCont) + "天")])]), _c('div', {
    staticClass: ["listChildren"]
  }, [_c('text', {
    staticClass: ["projectName"]
  }, [_vm._v("销售方式")]), _c('text', {
    staticClass: ["projectContent"]
  }, [_vm._v(_vm._s(_vm.orderSaleStyle))])]), (!_vm.isHours) ? _c('div', {
    staticClass: ["listChildren"]
  }, [_c('text', {
    staticClass: ["projectName"]
  }, [_vm._v("生效方式")]), ((_vm.effectiveType == 1)) ? _c('text', {
    staticClass: ["projectContent"]
  }, [_vm._v("指定日期生效")]) : _vm._e(), ((_vm.effectiveType == 2)) ? _c('text', {
    staticClass: ["projectContent"]
  }, [_vm._v("首次开课生效")]) : _vm._e()]) : _vm._e(), ((_vm.effectiveType == 1)) ? _c('div', {
    staticClass: ["listChildren"]
  }, [_c('text', {
    staticClass: ["projectName"]
  }, [_vm._v("有效期")]), _c('text', {
    staticClass: ["projectContent"]
  }, [_vm._v(_vm._s(_vm.orderStartTime) + "至" + _vm._s(_vm.orderEndTime))])]) : _vm._e(), (_vm.isHelp) ? _c('div', {
    staticClass: ["listChildren"]
  }, [_c('text', {
    staticClass: ["projectName"]
  }, [_vm._v("协助销售")]), _c('text', {
    staticClass: ["projectContent"]
  }, [_vm._v(_vm._s(_vm.orderHelpSale) + " " + _vm._s(_vm.orderPrecent) + "%")])]) : _vm._e(), (_vm.isNotes) ? _c('div', {
    staticClass: ["listChildren"]
  }, [_c('text', {
    staticClass: ["projectName"]
  }, [_vm._v("备注")]), _c('text', {
    staticClass: ["projectContent"]
  }, [_vm._v(_vm._s(_vm.orderNotes))])]) : _vm._e()]), _c('div', {
    staticClass: ["earnestList"]
  }, [_c('div', {
    staticClass: ["listChildren"]
  }, [_c('text', {
    staticClass: ["projectName"]
    ...
    staticClass: ["projectContent"]
  }, [_vm._v(_vm._s(_vm.orderAmount) + " 元")])]), ((_vm.isPanny)) ? _c('div', {
    staticClass: ["listChildren"]
  }, [_c('text', {
    staticClass: ["projectName"]
  }, [_vm._v("定金抵扣")]), _c('text', {
    staticClass: ["projectContent"]
  }, [_vm._v("-" + _vm._s(_vm.orderPanny) + " 元")])]) : _vm._e(), _c('div', {
    staticClass: ["listChildren"]
  }, [_c('text', {
    staticClass: ["projectName"]
  }, [_vm._v("实收金额")]), _c('text', {
    staticClass: ["payMoney"]
  }, [_vm._v(_vm._s(_vm.orderRealPrice) + " 元")])])])])]), (_vm.isFinish && _vm.payResult == 0) ? _c('div', {
    staticClass: ["editAndPayBox"],
    style: {
      visibility: _vm.payVisibility
    }
  }, [(_vm.signaturePhoto == null || _vm.isSkipSign) ? _c('text', {
    staticClass: ["editCourseBtnTxt"],
    on: {
      "click": _vm.editOrder
    }
  }, [_vm._v("编辑信息")]) : _c('text', {
    staticClass: ["editCourseBtnTxt"],
    on: {
      "click": _vm.toSignPage
    }
  }, [_vm._v("查看合同")]), (_vm.signaturePhoto != null || !_vm.signatureRequired || _vm.isSkipSign) ? _c('text', {
    staticClass: ["checkInTxt"],
    on: {
      "click": _vm.toPay
    }
  }, [_vm._v("发起付款")]) : _vm._e(), (_vm.signatureRequired && _vm.signaturePhoto == null && !_vm.isSkipSign) ? _c('text', {
    staticClass: ["checkInTxt"],
    on: {
      "click": _vm.toSignPage
    }
  }, [_vm._v("客户签字")]) : _vm._e()]) : _vm._e(), (!_vm.isFinish && _vm.payResult != -1 && _vm.signatureRequired && _vm.signaturePhoto == null && !_vm.isSkipSign) ? _c('div', {
    staticClass: ["editAndPayBox"],
    style: {
      visibility: _vm.payVisibility
    }
  }, [_c('text', {
    staticClass: ["showPayPage"],
    on: {
      "click": _vm.toSignPage
    }
  }, [_vm._v("查看合同")])]) : _vm._e(), (_vm.isFinish && (_vm.payResult == -2 || _vm.payResult == -3)) ? _c('div', {
    staticClass: ["editAndPayBox"],
    style: {
      visibility: _vm.payVisibility
    }
  }, [_c('text', {
    staticClass: ["showPayPage", "againHandle"],
    on: {
      "click": _vm.deleteAndEditOrder
    }
  }, [_vm._v("重新办理")])]) : _vm._e(), ((_vm.showPayCode)) ? _c('div', {
  ...
  }, [_vm._v("¥" + _vm._s(_vm.needPayMoney))])])]), _c('div', {
  ...
  }, [_vm._v("已支付")])])])]) : _vm._e(), ((_vm.isDelete)) ? _c('div', {
...
__vue_options__.__file = "F:\\weex项目\\教练购课\\buyCourse\\src\\payOrder\\payOrder.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-faadfef4"
__vue_options__.style = __vue_options__.style || {}
__vue_styles__.forEach(function (module) {
  for (var name in module) {
    __vue_options__.style[name] = module[name]
...
exports.default = {
    ...
    methods: {
            ...
            stream.fetch({
                ...
                if (!ret.ok) {
                    ...
                    if (ret.data.status == 0) {
                        ...
                        that.realPrice = ret.data.data.prePrivateCourse.payMethod1Amount, that.effectiveStyle = ret.data.data.prePrivateCourse.activatedMode;
                        ...
                        that.isQrSignEnable = ret.data.data.setting.qrSignEnable, that.isAppSignEnable = ret.data.data.setting.appSignEnable, that.allowSkipSign = ret.data.data.setting.allowSkipSign, that.protocolVersion = ret.data.data.protocol.version;
        ...
        showScanCode: function showScanCode() {
            var that = this;
            stream.fetch({
                method: "GET",
                type: 'json',
        ...
        hideScan: function hideScan() {
            this.isScanCode = false;
        },
        awakenSignPage: function awakenSignPage() {
            var that = this;
        ...
        skipSignEvent: function skipSignEvent() {
            this.showSkipSign = true;
        },
        cancelSkipSign: function cancelSkipSign() {
            this.showSkipSign = false;
        },
        submitSkipSign: function submitSkipSign() {
            var that = this;
            storage.setItem('isSkipSign', true, function (res) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: ["title"]
  }, [_vm._v("合同确认")]), (_vm.allowSkipSign && _vm.peopleSign == null) ? _c('text', {
    staticClass: ["nullBox"],
    on: {
      "click": _vm.skipSignEvent
    }
  }, [_vm._v("跳过签字")]) : _vm._e(), (!_vm.allowSkipSign || _vm.peopleSign != null) ? _c('text', {
    staticClass: ["nullBoxs"]
  }, [_vm._v("跳过签字")]) : _vm._e()]), _c('div', {
    ...
    staticClass: ["singleRowBox"]
  }, [_c('text', {
    staticClass: ["singleRowName"]
  }, [_vm._v("私教课")]), _c('text', {
    staticClass: ["singleRowText"]
  }, [_vm._v(_vm._s(_vm.courseName))])]), _c('div', {
    staticClass: ["singleRowBox"]
  }, [_c('text', {
    staticClass: ["singleRowName"]
  }, [_vm._v("有效期")]), _c('text', {
    staticClass: ["singleRowText"]
  }, [_vm._v(_vm._s(_vm.effectiveDays))])]), _c('div', {
    staticClass: ["singleRowParent"]
  }, [_c('div', {
    staticClass: ["singleRowBox"],
    staticStyle: {
      width: "325px"
    ...
    staticClass: ["singleRowText"]
  }, [_vm._v(_vm._s(_vm.buyCount) + "节")])]), _c('div', {
    staticClass: ["singleRowBox"],
    staticStyle: {
      width: "425px"
    }
    ...
    staticClass: ["singleRowText"]
  }, [_vm._v(_vm._s(_vm.teachingStyle == 1 ? '一对一' : '一对多'))])])]), _c('div', {
    staticClass: ["singleRowParent", "lastBox"]
  }, [_c('div', {
    staticClass: ["singleRowBox"],
    staticStyle: {
      width: "325px"
    ...
    staticClass: ["singleRowText"]
  }, [_vm._v("¥" + _vm._s(_vm.buyAmount))])]), (_vm.courseType == 2) ? _c('div', {
    staticClass: ["singleRowBox"],
    staticStyle: {
      width: "425px"
    }
    ...
    staticClass: ["singleRowText"]
  }, [_vm._v(_vm._s(_vm.effectiveStyle == 4 ? '首次上课生效' : '指定日期生效'))])]) : _vm._e()])]), _c('div', {
    staticClass: ["useCenters"]
  }, [_c('text', {
    staticClass: ["singleRowName"]
  }, [_vm._v("可用门店")]), _c('text', {
    staticClass: ["singleRowText", "warp"]
  }, [_vm._v(_vm._s(_vm.usableCenters))])]), _c('div', {
    staticClass: ["useCenters", "noBorder"]
  }, [_c('text', {
    staticClass: ["singleRowName"]
  }, [_vm._v("合同备注")]), _c('text', {
    staticClass: ["singleRowText"],
  ...
  }, [_vm._v(_vm._s(_vm.notes || '--'))])]), _c('div', {
    staticClass: ["buyerMess"]
  }, [_c('div', {
    staticClass: ["singleRowParent"],
    staticStyle: {
    ...
    staticClass: ["singleRowText"]
  }, [_vm._v(_vm._s(_vm.buyers))])]), _c('div', {
    staticClass: ["singleRowBox"],
    staticStyle: {
      width: "500px"
    }
    ...
    staticClass: ["singleRowText"]
  }, [_vm._v(_vm._s(_vm.buyPhone || '--'))])])]), _c('div', {
    staticClass: ["singleRowParent"],
    staticStyle: {
      borderBottomWidth: "0px"
    }
    ...
    staticClass: ["singleRowText"]
  }, [_vm._v(_vm._s(_vm.idType || '--'))])]), _c('div', {
    staticClass: ["singleRowBox"],
    staticStyle: {
      width: "500px"
    }
    ...
    staticClass: ["singleRowText"]
  }, [_vm._v(_vm._s(_vm.idNumber || '--'))])])])]), _c('div', {
    staticClass: ["useCenter", "noBorder"]
  }, [_c('text', {
    staticClass: ["singleRowName"]
  }, [_vm._v("销售人")]), _c('text', {
    staticClass: ["singleRowText"]
  }, [_vm._v(_vm._s(_vm.saler))])]), _c('div', {
    staticClass: ["centerSignBox", "noBorder"]
  }, [_c('div', {
    staticClass: ["centerDefaultBox"]
  }, [_c('text', {
    staticClass: ["centerDefaultTitle"]
  }, [_vm._v("场馆签字/印章")]), _c('image', {
    staticClass: ["centerSignImg"],
    attrs: {
      "src": _vm.centerSign
    }
  })]), _c('div', {
    staticClass: ["signLine"]
  }), _c('div', {
    staticClass: ["centerDefaultBox"]
  }, [_c('text', {
    staticClass: ["centerDefaultTitle"]
  }, [_vm._v("会员签字")]), _c('span', {
    staticClass: ["nullSign"]
  }, [(_vm.peopleSign == null) ? _c('text', {
    staticClass: ["nullSignTxt"]
  }, [_vm._v("未签字")]) : _c('image', {
    staticClass: ["centerSignImg"],
    attrs: {
      "src": _vm.peopleSign
    }
  })])])]), (_vm.protocol != '' && _vm.protocolVersion != null && _vm.protocolVersion != undefined) ? _c('div', {
    staticClass: ["protocolBoxContent"]
  }, [_c('text', {
    staticClass: ["protocolBoxTitle"]
  }, [_vm._v("服务协议")]), _c('text', {
    staticClass: ["protocolVersion"]
  }, [_vm._v("协议版本号：" + _vm._s(_vm.protocolVersion))]), _c('text', {
    staticClass: ["protocolVersion"]
  }, [_vm._v("发布日期：" + _vm._s(_vm.protocolData))]), _c('text', {
    staticClass: ["protocolTxt"]
  }, [_vm._v(_vm._s(_vm.protocloTxt))])]) : _vm._e()])])]), (_vm.peopleSign == null && (_vm.isQrSignEnable && _vm.isAppSignEnable)) ? _c('div', {
    staticClass: ["editAndPayBox"]
  }, [_c('text', {
    staticClass: ["editCourseBtnTxt"],
    on: {
      "click": _vm.showScanCode
    }
  }, [_vm._v("扫码确认")]), _c('text', {
    staticClass: ["checkInTxt"],
    on: {
      "click": _vm.awakenSignPage
    }
  }, [_vm._v("客户签字")])]) : _vm._e(), (_vm.peopleSign == null && (_vm.isQrSignEnable && !_vm.isAppSignEnable)) ? _c('div', {
    staticClass: ["editAndPayBox"]
  }, [_c('text', {
    staticClass: ["scanBtn"],
    on: {
  ...
  }, [_vm._v("扫码确认")])]) : _vm._e(), (_vm.peopleSign == null && (_vm.isAppSignEnable && !_vm.isQrSignEnable)) ? _c('div', {
    staticClass: ["editAndPayBox"]
  }, [_c('text', {
    staticClass: ["scanBtn"],
    on: {
  ...
  }, [_vm._v("客户签字")])]) : _vm._e(), (_vm.peopleSign != null && _vm.isFinish) ? _c('div', {
    staticClass: ["editAndPayBox"],
    style: {
      visibility: _vm.payVisibility
    }
  ...
  }, [_vm._v("发起付款")])]) : _vm._e(), ((_vm.showPayCode)) ? _c('div', {
    staticClass: ["bg", "centerBg"],
    style: {
      height: _vm.height
    }
  }, [_c('div', {
    staticClass: ["codeBoxs"]
  }, [_c('div', {
    staticClass: ["qrCodeTop"]
  }, [_c('div', {
    staticClass: ["codeTitle"]
  }, [_c('text', {
    staticClass: ["nullBoxTxt"],
    staticStyle: {
      width: "32px"
    }
  }, [_vm._v("12")]), _c('text', {
  ...
  }, [_vm._v("已支付")])])])]) : _vm._e()]), ((_vm.showSkipSign)) ? _c('div', {
    staticClass: ["bg", "deletePop"],
    style: {
      height: _vm.height
    },
    on: {
      "click": _vm.cancelSkipSign
    }
  }, [_c('div', {
    staticClass: ["deletePopBox"]
  }, [_c('text', {
    ...
    staticClass: ["deletePopContent"]
  }, [_vm._v("跳过签字后可直接进行付款， 之后补签合同需在电脑端操作～")]), _c('div', {
    staticClass: ["deleteBtnBox"]
  }, [_c('text', {
    staticClass: ["cancelDelete"],
    on: {
...
__vue_options__.__file = "F:\\weex项目\\教练购课\\buyCourse\\src\\index.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
